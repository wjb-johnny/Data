...
def computeTF(wordDict, doc):
    ...
    # init dictionary
    tfDict = {}
    corpusCount = len(doc) # total No. of words in the document
    for word, count in wordDict.items():
        tfDict[word] = count/float(corpusCount) # TF = No.of the specific word in the document/Total No. of words in the document
    return(tfDict)
